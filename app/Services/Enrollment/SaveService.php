...
class SaveService
{
    public function enrollment($request){
        ...
        return [
            ...
            'message' => 'Scholar was enrolled successfully!', 
            'info' => "You've successfully enrolled the scholar.",
        ];
    }
    ...
    public function grade($request){
        ...
        if($data->save()){
            ...
            if($request->subtype == 'monitoring'){
                ...
                return [
                    'data' =>  ($data) ? $data : ['id' => $request->id,'code' => 'empty'],
                    'message' => 'Grade updated successfully!', 
                    'info' => "You've successfully assess the scholar.",
                ];
            }else{
                $data = ScholarEnrollment::with('semester.semester','level','subjects')->where('id',$request->id)->first();
                return [
    ...
    public function unlockGrade($request){
        ...
        return [
            'data' => new EnrollmentResource($data),
            'message' => 'Grade was unlocked successfully!', 
            'info' => "You can update the grades again.",
        ];
    }
    ...
    public function lockGrade($request){
        ...
        return [
            'data' => new EnrollmentResource($data),
            'message' => 'Grade was locked successfully!', 
            'info' => "You cannot update the grades anymore.",
        ];
    }
}
