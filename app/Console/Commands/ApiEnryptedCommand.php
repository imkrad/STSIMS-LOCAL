...
{
    protected $signature = 'stsims:api {encrypted_data : Encrypted data for API configuration}';
    protected $description = 'Set the API configuration for STSIMS';
    ...
    public function handle()
    {
        ...
        $this->updateEnvVariable('AGENCY_ID', $id);
