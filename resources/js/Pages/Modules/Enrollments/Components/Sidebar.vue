<template>
    <div class="p-4 d-flex flex-column h-100" style="overflow: auto;">
        ...
        <ul class="list-unstyled mb-0 vstack gap-3" v-else>
            <li>
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <h6 class="fs-14 mb-1 text-primary text-uppercase">{{scholar.profile.name}}</h6>
            ...
            <li class="mt-n3"><i class="mdi mdi-school-outline me-2 align-middle text-primary fs-16"></i><span class="fs-12">{{(scholar.education.course.name) ? scholar.education.course.name : scholar.education.course.shortcut }}</span></li>
