<template>
    ...
    <Enrollment @update="clear" ref="enrollment"/>
    <Switch ref="switch" @update="handleUpdate"/>
    <Retake @add="addsubject" ref="retake"/>
</template>
 <script>
import Retake from './Retake.vue';
import Switch from './Switch.vue';
import Enrollment from './Enrollment.vue';
import simplebar from 'simplebar-vue';
export default {
    components: { simplebar, Retake, Switch, Enrollment },
    data(){
        return {
    ...
    methods: {
        ...
        clear(){
            this.$emit('clear',this.$page.props.flash.data.data);
        }
    }
 }
 </script>