<template>
    <b-col lg class="mt-3">
        <div class="input-group mb-3 mt-n1">
            ...
            <input type="text" v-model="filter.keyword" placeholder="Search Course" class="form-control" style="width: 30%;">
        </div>
    </b-col>
        ...
        <table class="table table-nowrap align-middle mb-0">
            <thead class="table-light">
                <tr class="fs-11">
                    ...
                    <th style="width: 16%;" class="text-center">Scholars</th>
                    <th style="width: 16%;" class="text-center">Certification</th>
                    <th style="width: 16%;" class="text-center">Validity</th>
