            ...
            <div class="col-md-10">
                <div class="p-2">
                    <div class="text-center">
                        ...
                        <div class="p-2 mt-4">
                            <p class="text-muted">All updated scholars should be synced to the central server so that we can track the updates. We found <b>{{count}}</b> data to be sync.</p>
