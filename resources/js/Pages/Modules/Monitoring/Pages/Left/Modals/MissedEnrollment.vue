<template>
    <b-modal v-model="showModal" title="Missed Enrollments" :hide-footer="(viewScholar) ? false : true" style="--vz-modal-width: 900px;" header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" centered>    
...
export default {
   ...
   methods: {
        ...
        fetch(page_url){
            ...
            axios.get(page_url, {
                params: {option: 'missed_enrollments', keyword: this.filter.keyword}
            })
            .then(response => {
