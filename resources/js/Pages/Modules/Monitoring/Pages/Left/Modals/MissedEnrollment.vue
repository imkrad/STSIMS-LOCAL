<template>
    <b-modal v-model="showModal" title="Missed Enrollments" hide-footer style="--vz-modal-width: 900px;" header-class="p-3 bg-light" class="v-modal-custom" modal-class="zoomIn" centered>    
