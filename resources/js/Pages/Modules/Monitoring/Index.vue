<template lang="">
    ...
    <PageHeader title="Monitoring" pageTitle="Menu" />
...
<script>
import Left from './Pages/Left/Index.vue';
import Right from './Pages/Right/Index.vue';
import Middle from './Pages/Middle/Index.vue';
